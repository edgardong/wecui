...
<template>
  <section class="demo-swipe">
    ...
    <h2>基础用法</h2>
    <wec-swipe @change="changeHadler" :duration="5000" :speed="300">
    ...
    <h2>单个幻灯片</h2>
     <wec-swipe>
      <wec-swipe-item class="slide1">SINGLE PAGE</wec-swipe-item>
    </wec-swipe>
  </section>
</template>
<script>

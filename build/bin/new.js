...
let JS_COMPONENT_INSTALL = `  Vue.\${{package}} = Vue.prototype.\${{package}} = {{name}}`;
...
var template = render(MAIN_TEMPLATE, {
  ...
  jscomponents: jsComponentTemplate.join(endOfLine)
});

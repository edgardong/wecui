    ...
    <transition name="bottomtop">
      <div class="wec-actionsheet" v-show="currentValue">
        <div class="wec-actionsheet__content">
          <div
            class="wec-actionsheet__content--item"
            :class="{'item-last': index== actions.length-1}"
            @click="itemClickHandler(action.action,index)"
          ...
          <div
            v-if="cancelText"
            class="wec-actionsheet__content--item item-cancel"
            @click="itemClickHandler('cancel')"
          >{{cancelText}}</div>
        </div>
      </div>
    </transition>

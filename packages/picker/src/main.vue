<template>
  <div class="wec-picker" v-if="visiable && currentVisiable" @click="maskerHandler">
        ...
        <div class="picker-wrapper">
          <div class="scroll-wrapper">
            <div class="picker-slot">
              <picker-item :slotObj="slot" v-model="values[slot.slotIndex]" :class="{'divider-item':slot.divider,'content-item': !slot.divider}" v-for="(slot,index) in slots" :key="index"></picker-item>
              <!-- 中部高亮区域 -->
